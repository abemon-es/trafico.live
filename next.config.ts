...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdnjs.cloudflare.com https://www.googletagmanager.com https://cal.trafico.live",
      "style-src 'self' 'unsafe-inline'",
      "font-src 'self' https://fonts.openmaptiles.org https://tiles.trafico.live https://protomaps.github.io",
      "img-src 'self' data: https: blob:",
      "connect-src 'self' https://tiles.trafico.live https://protomaps.github.io https://*.cartocdn.com https://*.carto.com https://fonts.openmaptiles.org https://*.google-analytics.com https://*.analytics.google.com https://www.googletagmanager.com https://*.openseamap.org https://tiles.openseamap.org https://tile.openweathermap.org https://server.arcgisonline.com https://marine-api.open-meteo.com https://api.open-meteo.com",
      "worker-src 'self' blob:",
      "frame-src https://cal.trafico.live",
