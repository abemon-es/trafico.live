    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link
          ...
          className="p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 hover:shadow-md transition-shadow"
        >
          <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Listado Terrestres</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">Ver todas las gasolineras terrestres</p>
        </Link>
        <Link
          href="/gasolineras/maritimas"
          className="p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 hover:shadow-md transition-shadow"
        >
          <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Listado Marítimas</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">Ver estaciones en puertos</p>
        </Link>
        <Link
          href="/gasolineras/precios"
          className="p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 hover:shadow-md transition-shadow"
        >
          <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Precios por Provincia</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">Comparativa de precios</p>
        </Link>
      </div>
    </div>
  );
