      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-gradient-to-r from-tl-50 to-tl-100 rounded-lg p-6 mb-6 border border-tl-200 dark:border-tl-800">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Autovías de España</h1>
              <p className="text-gray-600 dark:text-gray-400">Vías de alta capacidad sin peaje (A)</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
            <div className="bg-white dark:bg-gray-900 rounded-lg p-4 shadow-sm">
              <div className="text-2xl font-bold text-tl-600 dark:text-tl-400">{roads.length}</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Autovías</div>
            </div>
            <div className="bg-white dark:bg-gray-900 rounded-lg p-4 shadow-sm">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50 dark:bg-gray-950 border-b">
                  <tr>
                    <th className="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Autovía</th>
                      ...
                      <tr key={road.id} className="border-b hover:bg-gray-50 dark:bg-gray-950">
                        <td className="py-3 px-4">
                          <Link
                            ...
                            className="font-semibold text-tl-600 dark:text-tl-400 hover:text-tl-800 dark:text-tl-200"
                          >
                            {road.id}
                          </Link>
                        </td>
