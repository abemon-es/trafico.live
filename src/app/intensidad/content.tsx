...
const IntensidadCharts = dynamic(() => import("./IntensidadCharts"), {
  ssr: false,
  loading: () => <div className="h-[360px] animate-pulse rounded-lg bg-white/5" />,
});
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {isLoading ? (
        ...
        <>
          ...
          {/* ── Charts: year evolution + province comparison (deferred) ── */}
          <IntensidadCharts years={years} chartData={chartData} />
