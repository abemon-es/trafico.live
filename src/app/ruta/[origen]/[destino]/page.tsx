...
/**
 * /ruta/[origen]/[destino] — SEO-variant that consolidates into /ir.
 *
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = pair
    ? `Ruta de ${pair.originName} a ${pair.destName} | trafico.live`
    : "Ruta | trafico.live";
...
export default async function RutaODPage({ params }: PageProps) {
  const { origen, destino } = await params;
