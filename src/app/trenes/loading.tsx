/**
 * Skeleton de carga para /trenes — mapa hero oscuro + estadísticas.
 */
export default function TrenesLoading() {
  return (
    <div
    ...
    >
      ...
      <div className="relative w-full h-[420px] sm:h-[520px] bg-slate-900 animate-pulse mt-4">
        {/* Live train count chip */}
        <div className="absolute top-4 left-4 h-8 w-32 rounded-full bg-white/10 animate-pulse" />
        {/* Layer toggle placeholder */}
        <div className="absolute top-4 right-4 h-8 w-20 rounded-lg bg-white/10 animate-pulse" />
        {/* Legend placeholder */}
        <div className="absolute bottom-4 left-4 h-24 w-40 rounded-xl bg-white/10 animate-pulse" />
      </div>
      ...
      {/* Content rows */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 space-y-4">
