        ...
        <table className="w-full text-sm border-collapse">
          ...
          <tbody>
            ...
            <tr className="hover:bg-gray-50">
              ...
              <td className="px-4 py-3 font-medium text-green-700 border border-gray-200">
                1.760 €
              </td>
              <td className="px-4 py-3 text-gray-700 border border-gray-200">
                2.080 €
          ...
          <tbody>
            {DECISION_MATRIX.map((row) => (
              <tr key={row.factor} className="hover:bg-gray-50">
                ...
                <td
                  className={`px-4 py-3 border border-gray-200 ${row.winner === "diesel" ? "text-green-700 font-medium" : "text-gray-600"}`}
                >
                  {row.diesel}
                </td>
                <td
                  className={`px-4 py-3 border border-gray-200 ${row.winner === "gasolina" ? "text-green-700 font-medium" : "text-gray-600"}`}
                >
                  {row.gasolina}
                </td>
                <td className="px-4 py-3 text-gray-500 border border-gray-200 capitalize">
                  {row.winner}
                </td>
              </tr>
            ))}
