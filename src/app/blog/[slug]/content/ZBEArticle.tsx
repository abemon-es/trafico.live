...
const STICKERS = [
  {
    label: "Cero (0)",
    color: "bg-tl-100 dark:bg-tl-900/30 text-tl-800 dark:text-tl-200 border-tl-300",
  ...
  {
    label: "Sin etiqueta",
    color: "bg-red-100 dark:bg-red-900/30 text-red-800 border-red-300",
        ...
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr className="bg-gray-100 dark:bg-gray-900">
              <th className="text-left px-4 py-3 font-semibold text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-800">Ciudad</th>
              <th className="text-left px-4 py-3 font-semibold text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-800">Zona</th>
              <th className="text-left px-4 py-3 font-semibold text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-800">Desde</th>
              <th className="text-left px-4 py-3 font-semibold text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-800">Área</th>
            </tr>
          </thead>
          <tbody>
            {ZBE_CITIES.map((row) => (
              <tr key={row.city} className="hover:bg-gray-50 dark:bg-gray-950">
                <td className="px-4 py-3 font-medium text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-800">
                  {row.city}
                </td>
                <td className="px-4 py-3 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-800">{row.zone}</td>
                <td className="px-4 py-3 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-800">{row.since}</td>
                <td className="px-4 py-3 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-800">{row.area}</td>
              </tr>
            ))}
          </tbody>
        </table>
