    ...
    loading: () => (
      <div className="w-full h-full bg-tl-50 dark:bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          <Bus className="w-12 h-12 text-tl-300 mx-auto mb-3 animate-pulse" />
          <p className="text-sm text-tl-500 font-['DM_Sans']">Cargando transporte público...</p>
        </div>
      </div>
    ),
  }
...
export function MapaClient() {
  return (
    <TraficoMap
      ...
      controls={{ lensBar: "transporte-publico", layerPanel: true, legend: true, themeToggle: true, fullscreen: true }}
      syncUrl
