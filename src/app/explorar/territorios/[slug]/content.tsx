    ...
    return (
      <div className="flex items-center justify-center py-20">
        <div className="text-center">
          ...
          <p className="text-gray-500">No se pudieron cargar los datos del territorio</p>
          <Link href="/explorar/territorios" className="mt-4 inline-block text-blue-600 hover:underline">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
        ...
        <span>/</span>
        <Link href="/explorar/territorios" className="hover:text-blue-600">
          Territorios
        </Link>
        <span>/</span>
