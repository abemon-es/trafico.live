...
export const COMMUNITIES: Community[] = [
  ...
  { code: "09", name: "Cataluña", isExcluded: true, excludedReason: "Regional traffic system (SCT)" },
  ...
  { code: "16", name: "País Vasco", isExcluded: true, excludedReason: "Regional traffic system (Euskadi)" },
