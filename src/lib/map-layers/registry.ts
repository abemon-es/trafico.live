...
export const LAYER_REGISTRY: LayerDefinition[] = [
...

  {
    ...
    style: {
      ...
      layout: {
        ...
        "icon-size": ["interpolate", ["linear"], ["zoom"], 3, 0.2, 8, 0.4, 14, 0.65],
...

  {
    ...
    style: {
      ...
      layout: {
        ...
        "icon-size": ["interpolate", ["linear"], ["zoom"], 4, 0.25, 10, 0.5, 14, 0.7],
        "icon-allow-overlap": true,
        "icon-ignore-placement": true,
      },
    },
...

  {
    ...
    style: {
      ...
      layout: {
        ...
        "icon-size": ["interpolate", ["linear"], ["zoom"], 4, 0.25, 8, 0.45, 14, 0.7],
        "icon-allow-overlap": true,
        "icon-ignore-placement": true,
        "icon-rotation-alignment": "map",
...

  {
    ...
    style: {
      ...
      layout: {
        ...
        "icon-size": ["interpolate", ["linear"], ["zoom"], 4, 0.25, 10, 0.5, 14, 0.75],
        "icon-allow-overlap": true,
        "icon-ignore-placement": true,
      },
    },
...

  {
    ...
    style: {
      ...
      layout: {
        ...
        "icon-size": ["interpolate", ["linear"], ["zoom"], 5, 0.3, 10, 0.55, 14, 0.85],
        "icon-allow-overlap": true,
        "icon-ignore-placement": true,
      },
      paint: {
...

  {
    ...
    style: {
      ...
      layout: {
        ...
        "icon-size": ["interpolate", ["linear"], ["zoom"], 5, 0.18, 10, 0.38, 14, 0.6],
        "icon-allow-overlap": true,
        "icon-ignore-placement": true,
      },
    },
...

  {
    ...
    style: {
      ...
      layout: {
        ...
        "icon-size": ["interpolate", ["linear"], ["zoom"], 7, 0.24, 11, 0.4, 14, 0.58],
        "icon-allow-overlap": true,
        "icon-ignore-placement": true,
      },
    },
...

  {
    ...
    style: {
      ...
      layout: {
        ...
        "icon-size": ["interpolate", ["linear"], ["zoom"], 7, 0.22, 11, 0.4, 14, 0.58],
        "icon-allow-overlap": true,
        "icon-ignore-placement": true,
      },
    },
...

  {
    ...
    style: {
      ...
      layout: {
        "icon-image": "icon-fuel",
        "icon-size": ["interpolate", ["linear"], ["zoom"], 7, 0.22, 11, 0.38, 14, 0.55],
        "icon-allow-overlap": true,
        "icon-ignore-placement": true,
      },
    },
