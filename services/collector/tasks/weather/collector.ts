      ...
      try {
        await prisma.weatherAlert.upsert({
          ...
          create: {
            ...
            isActive: true,
            windSpeedKmh: alert.windSpeedKmh ?? null,
            windGustKmh: alert.windGustKmh ?? null,
            tempMinC: alert.tempMinC ?? null,
            tempMaxC: alert.tempMaxC ?? null,
            rainfallMm: alert.rainfallMm ?? null,
            snowLevelM: alert.snowLevelM ?? null,
            waveHeightM: alert.waveHeightM ?? null,
          },
          update: {
            endedAt: alert.endedAt,
            fetchedAt: now,
