...
if (!TASK) {
  console.error("TASK environment variable is required. Valid tasks: v16, incident, panel, weather, camera, radar, charger, speedlimit");
  process.exit(1);
}

const VALID_TASKS = ["v16", "incident", "panel", "weather", "camera", "radar", "charger", "speedlimit"];
